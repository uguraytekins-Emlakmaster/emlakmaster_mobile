/// Görevlerim — mobile-first compact density (Müşterilerim ile aynı dil).
abstract final class ConsultantTasksTokens {
  ConsultantTasksTokens._();
  ...
  static const double rowCheckSize = 22;
}
