...
/// Bağlantılar komuta yüzeyi — Üyelikler / Ofis Masası density ile hizalı.
abstract final class AdminBaglantilarTokens {
  AdminBaglantilarTokens._();
  ...
  static const double rowMinHeight = 76;
