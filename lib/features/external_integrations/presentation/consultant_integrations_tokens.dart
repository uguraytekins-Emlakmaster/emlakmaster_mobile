/// Entegrasyon Merkezi — mobile-first compact density.
abstract final class ConsultantIntegrationsTokens {
  ConsultantIntegrationsTokens._();
  ...
  static const double rowPaddingV = 8;
