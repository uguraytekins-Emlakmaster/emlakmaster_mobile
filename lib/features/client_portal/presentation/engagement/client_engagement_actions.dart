...
/// İlgi & Etkileşim aksiyonları — her görünür aksiyon gerçek bir kabuk sekmesine
/// gider (dead button yok). Sunucuda izlenmeyen kanallar detayda dürüstçe
/// açıklanır.
  ...
  static void showDetailSheet(
    ...
    showModalBottomSheet<void>(
      ...
      builder: (ctx) {
        ...
        final honest = entry.readiness != EngagementReadiness.ready;
        return SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _DetailLine(label: 'Tür', value: entry.actionType),
                ...
                Text(
                  honest
                      ? 'Bu kanal henüz sunucuda izlenmiyor; uydurma kayıt '
