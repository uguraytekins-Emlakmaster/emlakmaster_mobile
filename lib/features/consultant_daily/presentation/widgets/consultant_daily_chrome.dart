...
class ConsultantDailySummaryStripView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final body = cells.isEmpty
        ? SizedBox(
            height: ConsultantDailyTokens.summaryStripHeight,
            child: Center(
              child: Text(
            ...
            child: Row(
              children: [
                for (var i = 0; i < cells.length; i++) ...[
                  if (i > 0)
                    SizedBox(
                      width: MediaQuery.sizeOf(context).width < 360 ? 4 : 6,
                    ),
                  Expanded(
...
class _DailySummaryCell extends StatelessWidget {
  const _DailySummaryCell({
    required this.value,
    required this.label,
    required this.color,
    this.compact = false,
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                color: color,
                fontSize: compact
                    ? ConsultantDailyTokens.summaryCellValueSize - 1
