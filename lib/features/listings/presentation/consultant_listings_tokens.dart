/// İlanlarım — mobile-first compact density (Görevlerim / Müşterilerim ile aynı dil).
abstract final class ConsultantListingsTokens {
  ConsultantListingsTokens._();
  ...
  static const double rowThumbSize = 52;
  static const double rowTitleSize = 13.5;
  static const double rowMetaSize = 10.5;
  static const double statusChipFontSize = 9.5;
  static const double actionIconSize = 18;
  static const double actionTapSize = 32;
}
