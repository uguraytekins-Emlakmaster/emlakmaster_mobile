...
/// Aynı müşteri + öneri kodu için kısa süreli bastırma (görev oluşturuldu veya gizlendi).
class TaskSuggestionDedupeStore {
  static const String _prefix = 'task_sug_suppress_v1_';
  static const Duration defaultTtl = Duration(hours: 48);
